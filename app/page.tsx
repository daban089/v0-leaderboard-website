        ...
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <img
                src="/images/jangamar-logo.png"
                alt="Jangamar's Tiers"
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <a
                ...
                className="flex items-center gap-2 px-3 py-2 text-foreground h-10 sm:h-12 w-full sm:w-auto justify-center"
              >
              ...
              {/* Search Bar */}
              <div className="relative h-10 sm:h-12 w-full sm:w-auto">
