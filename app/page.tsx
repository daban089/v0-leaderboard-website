  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-500 ${
        mode === "ranked"
          ? "bg-gradient-to-br from-purple-950/30 via-background to-purple-900/20"
          : "bg-gradient-to-br from-red-950/30 via-background to-red-900/20"
      }`}
    >
      {/* Header */}
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <img
                src={mode === "ranked" ? "/images/minecraft-title-2826-29.png" : "/images/jangamar-logo.png"}
                alt={mode === "ranked" ? "Tiers Ranked" : "Jangamar's Tiers"}
      ...
      <div className="container mx-auto px-4 py-8">
        <LeaderboardTable kit={activeKit} searchQuery={searchQuery} onKitChange={setActiveKit} onModeChange={setMode} />
      </div>
